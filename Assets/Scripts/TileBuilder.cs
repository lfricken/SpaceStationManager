...
namespace SSM
{
	...
	{
		public static void CreateTile<T>(LayerType layer, string tileName, string path = null) where T : Tile
		{
			CreateAsset(CreateTile<T>(layer), tileName, path);
		}

		public static T CreateTile<T>(LayerType layer) where T : Tile
		{
